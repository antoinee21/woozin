...
export const MOCK_EVENTS: EventCardData[] = [
  ...
  {
    id: '7',
    title: 'Karaoké samedi soir',
    date: new Date(Date.now() + 3 * 24 * 60 * 60 * 1000),
    location: 'Sing Sing, Oberkampf',
    maxParticipants: 12,
    confirmed: 5,
    maybe: 2,
    no: 1,
  ...
  {
    id: '8',
    title: 'Rando forêt de Fontainebleau',
...
export const MOCK_EVENT_DETAILS: Record<string, MockEventDetail> = {
  ...
  '7': {
    ...
    participants: [
      ...
      { id: 'u3', name: 'Théo', status: 'yes' },
      { id: 'u4', name: 'Sarah', status: 'maybe' },
      { id: 'u9', name: 'Romain', status: 'maybe' },
    ],
  },
  '8': {
    id: '8',
    ...
    participants: [
      ...
      { id: 'u4', name: 'Sarah', status: 'yes' },
      { id: 'u1', name: 'Lucas', status: 'yes' },
      { id: 'u9', name: 'Romain', status: 'yes' },
      { id: 'u10', name: 'Camille', status: 'maybe' },
      { id: 'u11', name: 'Antoine', status: 'maybe' },
      { id: 'u12', name: 'Inès', status: 'maybe' },
    ],
  },
}
